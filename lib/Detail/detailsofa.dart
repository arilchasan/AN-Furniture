...
import '../Cart/cartdb.dart';
import '../Cart/cartmodel.dart';

class detailsofa extends StatefulWidget {
  final SofaModel furniture;

  const detailsofa({Key? key, required this.furniture}) : super(key: key);

  @override
  State<detailsofa> createState() => _detailsofaState();
}

class _detailsofaState extends State<detailsofa> {
