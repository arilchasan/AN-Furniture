...
class detailkursi extends StatefulWidget {
  ...
  const detailkursi({Key? key, required this.furniture}) : super(key: key);

  @override
  State<detailkursi> createState() => _detailkursiState();
}

class _detailkursiState extends State<detailkursi> {
